...
usage() {
    ...
    echo "  chunk_bwd_dv_local, chunk_kda_bwd_intra, causal_conv1d, prepare_wy_repr_bwd_da,"
...
run_test "chunk_kda_bwd_intra"             "python3 -m pytest -q test_npu_chunk_kda_bwd_intra.py -s"
